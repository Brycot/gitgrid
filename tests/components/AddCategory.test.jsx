...
describe("Pruebas en <AddCategory />", () => {
    ...
    test('Debe de llamar onNewCategory si el input tiene un valor', () => { 
        ...
        // expect( onNewCategory ).toHaveBeenCalledTimes(1); // que se haya llamado x veces
        expect( onNewCategory ).toHaveBeenCalledWith( inputValue ); // que se haya llamado con x argumento
    })
